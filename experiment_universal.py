...
if __name__ == "__main__":
    ...
    if dataset_name == "sst2":
        ...
        target_g = "World"
    params['malicious_instruction_g'] = malicious_instruction_g
    ...
    training_indices_batched = [
        label_0_indices[i * attack_batch_size : (i + 1) * attack_batch_size]
    ...
    max_memory = {0: "11GiB", 1: "11GiB", 2: "11GiB",3: "11GiB", "cpu": "128GiB"}  # 0: "1GiB", 1: "1GiB", 2: "0GiB",
    try:
    ...
    formatted_result = formatted_result_list[len(formatted_result_list) - 1][
        maximum_attack_idx
    ]
